...
<body class="h-full bg-gray-50 dark:bg-gray-900">
    <div class="flex h-full">
        ...
        <!-- Main Content -->
        <div id="main-content" class="flex-1 flex flex-col overflow-hidden lg:ml-64 transition-all duration-300">
            <!-- Header -->
            @include('admin.partials.header')
            
            <!-- Page Content -->
            <main class="flex-1 overflow-y-auto bg-gray-50 dark:bg-gray-900 p-4 lg:p-8">
                @if (session('success'))
